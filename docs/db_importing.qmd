...
2. [Arize Phoenix](#arize-phoenix), [LangSmith](#langsmith), [Logfire](#logfire), [W&B Weave](#wb-weave), and [Datadog](#datadog): Read transcript data from LLM observability platforms.
...
::: {.callout-note}
The W&B Weave import source described below is available only in the development version of Inspect Scout. Install the development version from GitHub with:
...
::: {.callout-note}
The Claude Code transcript source described below is available only in the development version of Inspect Scout. Install the development version from GitHub with:
